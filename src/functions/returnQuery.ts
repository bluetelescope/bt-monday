...
export function returnAddSubitem(
  ...
  return {
    query:
      'mutation {\n  create_subitem(\n    parent_item_id: 7263412897\n    item_name: "Hours Log"\n    column_values:"{ "hours__1": "4",  "timeline3__1": {    "to": "2024-04-26",    "from": "2024-04-22",    "changed_at": "2024-08-23T00:09:08.595Z"  },  "person": {    "personsAndTeams": [      {        "id": 27253155,        "kind": "person"      }    ]  },  "cost__1": "5"}"\n    \n    create_labels_if_missing: true\n) {\n  id\n  name\n  column_values {value text id column {title}}\n}\n}',
  };
}
